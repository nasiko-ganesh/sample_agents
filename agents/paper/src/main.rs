...
impl AgentExecutor for PaperAgent {
    fn execute(&self, ctx: ExecutorContext) -> BoxStream<'static, Result<StreamResponse, A2AError>> {
        ...
        let stream = async_stream::stream! {
            ...
            let agent = PaperAgent { model, api_key, base_url, http };
...
async fn main() {
    ...
    let agent_card = AgentCard {
        name: "Paper Research Assistant".to_string(),
        description: "Search and analyze academic papers from arXiv and Semantic Scholar".to_string(),
        ...
        skills: vec![AgentSkill {
            id: "paper-search".into(),
            name: "Paper Search".into(),
            description: "Find and analyze academic papers on any topic".into(),
            tags: vec!["research".into(), "papers".into(), "arxiv".into(), "science".into()],
    ...
    tracing::info!("Paper Research Assistant listening on 0.0.0.0:{port}");
